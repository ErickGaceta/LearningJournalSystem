                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                <div x-show="showDeleteModal" 
                                    ...
                                    <div @click.away="showDeleteModal = false"
                                        ...
                                        <!-- Modal Footer -->
                                        <div class="bg-white dark:bg-neutral-800 px-6 py-4 flex gap-3">
                                            <button type="button" 
                                                @click="showDeleteModal = false"
                                                class="flex-1 px-2 py-0.5 bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 font-medium rounded-lg hover:bg-neutral-300 dark:hover:bg-neutral-600 transition-colors">
                                                Cancel
                                            </button>
                                            ...
                                            <form action="{{ route('divisions.destroy', $division) }}" method="POST" class="flex-1">
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="w-full px-2 py-0.5 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg transition-colors shadow-lg hover:shadow-xl">
                                                    Delete Permanently
                                                </button>
                                            </form>
                                        </div>
