<x-layouts.hr>
    <x-slot name="header">
        <flux:heading size="xl">Archived Training Modules</flux:heading>
        <flux:text variant="subtle" class="mt-1">Modules that have been archived and are no longer in active use.</flux:text>
    </x-slot>
