    ...
    <flux:card>
        <div class="space-y-6">
            ...
            <flux:field>
                ...
                <flux:textarea x-bind:readonly="!editing" name="topics" rows="4">{{ old('topics', $document->topics) }}</flux:textarea>
            ...
            <flux:field>
                ...
                <flux:textarea x-bind:readonly="!editing" name="insights" rows="4">{{ old('insights', $document->insights) }}</flux:textarea>
            ...
            <flux:field>
                ...
                <flux:textarea x-bind:readonly="!editing" name="application" rows="4">{{ old('application', $document->application) }}</flux:textarea>
                <flux:error name="application" />
            </flux:field>

            <flux:field>
                <flux:label>D. I was challenged most on...</flux:label>
                <flux:textarea x-bind:readonly="!editing" name="challenges" rows="4">{{ old('challenges', $document->challenges) }}</flux:textarea>
            ...
            <flux:field>
                ...
                <flux:textarea x-bind:readonly="!editing" name="appreciation" rows="4">{{ old('appreciation', $document->appreciation) }}</flux:textarea>
